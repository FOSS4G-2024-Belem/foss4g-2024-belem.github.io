...
export const metadata = {
  title: "Charlas Academicas",
  description:
    "Información de Charlas Academicas para la Conferencia FOSS4G 2024 celebrada en Belém, Brasil, del 02 al 08 de diciembre de 2024",
  image: null,
};

<Heading bubble>Academic Talks</Heading>

<div className="grid space-y-4 mt-4">
  <div className="grid md:grid-cols-2 gap-4">  
    <div className="">

      #### Academic Talks Description
      ---
