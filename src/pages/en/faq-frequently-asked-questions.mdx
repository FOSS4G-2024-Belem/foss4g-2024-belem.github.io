...
export const metadata = {
  ...
  description:
    "Common questions and answers about the FOSS4G 2024 Conference held in Belém, Brasil on 02-08 December 2024",
};
...
<Grid>
  ...
  <Column>
    ...
    <FaqBubble question="Are there any options for child care?">
      ...
      <a href="https://ee.kobotoolbox.org/x/RDso0hpi" target="_blank">Click here to sign up for childcare</a>! Childcare registration
