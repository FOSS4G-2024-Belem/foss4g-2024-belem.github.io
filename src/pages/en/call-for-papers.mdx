...
<Heading color="orange" bubble>General Talks</Heading>


<div className="grid space-y-4 mt-4">
  <div className="grid md:grid-cols-2 gap-4">  
    <div className="">
      #### General Talks Description
      ---
    ...
    * Business products powered by FOSS4G;
    ...
    Look at the <IntlLink href="/sponsors">sponsorship page</IntlLink> for additional information.
    </div>
  </div>
</div>
