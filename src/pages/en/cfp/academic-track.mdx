...
<div className="grid space-y-4 mt-4">
  <div className="grid md:grid-cols-2 gap-4">  
    <div className="">
      ...
      - **Call for Academic Track**: May 30, 2024
      - **Deadlines Open call for academic papers**: May 30 - June 30, 2024
      - **Announce accepted papers**: August 5, 2024
      - **Submission of full academic papers**: August 30, 2024
    ...
    **Step 2**:
    ...
    To format the papers submitted to this track, authors should follow the guidelines for ISPRS-sponsored events. You can find the guidelines for formatting abstracts and the camera-ready manuscript at [https://www.isprs.org/documents/orangebook/app5.aspx](https://www.isprs.org/documents/orangebook/app5.aspx).
