...
<div className="grid space-y-4 mt-4">
  <div className="grid md:grid-cols-2 gap-4">  
    ...
    <div className="text-center my-4 text-lg">
      &gt;&gt; <a href="https://docs.google.com/document/d/1c2EcYffUDJ2JfhNzG7mXykVaZhqbpUlG/edit?usp=drive_link&ouid=111236300229283489586&rtpof=true&sd=true" target="_blank">Academic Track Guidelines</a> &lt;&lt;
    </div>

    <div className="text-center my-4 text-lg">
      &gt;&gt; <a href="https://talks.osgeo.org/foss4g-2024/cfp" target="_blank">Click here to submit Academic Track proposal!</a> &lt;&lt;
    </div>
