...
<div className="grid space-y-4 mt-4">
  <div className="grid md:grid-cols-2 gap-4">  
    <div className="">
      ...
      **General talks must be sent in English.**
      ...
      - **Open call for general talks**: From May 8, 2024 to July 30, 2024.
      - **Community vote**: From August 1 to September 23, 2024.
      - **Ranking of the most voted talks**: From September 23 to 30, 2024.
      - **Full FOSS4G 2024 program**: From October 1st, 2024.
    ...
    * Last but not least, the success of this event lies in the responsible actions of all participants and organizers alike. If you or the co-authors can no longer be present after you have confirmed participation, please let us know as soon as possible.
    ...
    <div className="text-center my-6 text-xl">
      &gt;&gt; <a href="https://talks.osgeo.org/foss4g-2024/cfp" target="_blank">Click here to submit General Talk proposal!</a> &lt;&lt;
    </div>
