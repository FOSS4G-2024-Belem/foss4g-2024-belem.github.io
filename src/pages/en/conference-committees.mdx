...
<div className="mx-auto w-full max-w-[720px] my-4 6xl:my-8">
  ...
  At the heart of every successful conference lies a dedicated and enthusiastic team: the program creation committee. This group of professionals and volunteers carefully curates every detail, fusing innovation with experience to offer a better version for attendees.

  Their work not only translates into the diversity of topics addressed, but also in the careful selection of speakers and panels that will inspire, inform and connect participants. Their tireless dedication is the cornerstone that elevates each edition of the conference to new heights.
</div>
...
<div className="mx-auto w-full max-w-[720px] my-4 6xl:my-8">
  ##### About the Sponsor Committee

  Imagine a scenario where innovation and collaboration intertwine in an open source and geospatial technology environment. At a FOSS4G (Free and Open Source Software for Geospatial) conference, the Sponsor Committee plays a crucial role in bringing together companies, organizations and open source software enthusiasts to support and empower this vibrant community.
  
  From securing the necessary financial backing for the organization of the event to facilitating networking opportunities and visibility for sponsors, this committee creates a vital bridge between the open source community and the business world, promoting innovation, knowledge sharing and continued growth in the field of geospatial technology.
</div>
